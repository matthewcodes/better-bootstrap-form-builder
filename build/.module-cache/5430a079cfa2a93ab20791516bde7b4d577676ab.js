            ...
            React.createElement("div", {className: "col-md-5"}, 
              ...
              React.createElement("div", {className: "collapse", id: "collapseExample"}, 
                React.createElement("div", {className: "well"}, 
                  React.createElement("div", {className: "form-group"}, 
                    React.createElement("label", {for: "labelTextInput"}, "Enter value for label text:"), 
                    React.createElement("input", {type: "email", className: "form-control", id: "labelTextInput", onChange: this.handleLabelTextChange, text: this.state.labelText})
                  )
                )
              )
            )
