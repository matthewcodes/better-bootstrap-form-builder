        ...
        return (
          ...
          React.createElement("div", {className: "row"}, 
            ...
            React.createElement("div", {className: "col-md-2"}, 
              React.createElement("button", {type: "button", className: "btn btn-lg btn-danger", "data-toggle": "popover", title: "Popover title", "data-content": "And here's some amazing content. It's very engaging. Right?"}, 
                React.createElement("span", {className: "glyphicon glyphicon-align-left", "aria-hidden": "true"})
              )
            )
          )
