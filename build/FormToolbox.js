              ...
              React.createElement("div", {className: "collapse", id: "collapseExample"}, 
                React.createElement("div", {className: "well"}, 
                  React.createElement("div", {className: "form-group"}, 
                    ...
                    React.createElement("input", {className: "form-control", id: "EditlabelTextInput", ref: "labelTextInput", onChange: this.handleLabelTextChange, value: this.state.labelText})
                  )
                )
              )
            )
